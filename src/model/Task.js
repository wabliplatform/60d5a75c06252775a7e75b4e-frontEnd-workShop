...
class Task {
     ...
     * @param tPMs {String} 
     */
    constructor(tName, tStart, tEnd, tDescription, tPMs) { 
        
        Task.initialize(this, tName, tStart, tEnd, tDescription, tPMs);
    }
     ...
     */
    static initialize(obj, tName, tStart, tEnd, tDescription, tPMs) { 
        obj['tName'] = tName;
        obj['tStart'] = tStart;
        obj['tEnd'] = tEnd;
